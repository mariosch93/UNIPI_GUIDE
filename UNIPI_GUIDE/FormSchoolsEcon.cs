...
{
    public partial class FormSchoolsEcon : Form
    {
        bool sidebarExpand;
        bool UniCollapse;
        bool SchoolCollapse;
        ...
        private void richTextBoxDescription_MouseEnter(object sender, EventArgs e)
        {
            richTextBoxDescription.BackColor = Color.LightYellow;
            richTextBoxDescription2.BackColor = Color.Aqua;
            richTextBoxDescription3.BackColor = Color.Aqua;
        }

        private void richTextBoxDescription2_MouseEnter(object sender, EventArgs e)
        {
            richTextBoxDescription2.BackColor = Color.Aqua;
            richTextBoxDescription3.BackColor = Color.White;
        }

        private void richTextBoxDescription2_MouseLeave(object sender, EventArgs e)
        {
            richTextBoxDescription2.BackColor = Color.White;
            richTextBoxDescription3.BackColor = Color.Aqua;
        }

        private void richTextBoxDescription3_MouseEnter(object sender, EventArgs e)
        {
            richTextBoxDescription3.BackColor = Color.Aqua;
            richTextBoxDescription2.BackColor = Color.White;
        }

        private void richTextBoxDescription3_MouseLeave(object sender, EventArgs e)
        {
            richTextBoxDescription2.BackColor = Color.Aqua;
            richTextBoxDescription3.BackColor = Color.White;
        }

        private void richTextBoxDescription_MouseLeave(object sender, EventArgs e)
        {
