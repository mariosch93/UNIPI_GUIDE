...
namespace UNIPI_GUIDE
{
    public partial class FormAbout : Form
    {
        ...
        {
            System.Diagnostics.Process.Start("https://github.com/mariosch93");
        }

        private void linkLabelLinkedln_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.linkedin.com/in/marios-charidis/");
        }

        private void linkLabelFacebook_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.facebook.com/marios.charidis"); 
        }

        private void linkLabelInstagram_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.instagram.com/marios_charidis/");
        }
    }
}
